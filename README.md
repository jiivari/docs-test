# TestCompany OpenAPI Specification
[![Build Status](https://travis-ci.org/jiivari/docs-test.svg?branch=master)](https://travis-ci.org/jiivari/docs-test)
...
6. If you did everything correct, https://jiivari.github.io/docs-test/ will lead to your new docs
...
- Documentation(ReDoc): https://jiivari.github.io/docs-test/
- SwaggerUI: https://jiivari.github.io/docs-test/swagger-ui/
- Look full spec:
    + JSON https://jiivari.github.io/docs-test/swagger.json
    + YAML https://jiivari.github.io/docs-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://jiivari.github.io/docs-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://jiivari.github.io/docs-test/ with url from the message: `Server started <url>`
